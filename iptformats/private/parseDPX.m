...
case 0
    X = readCombinedPackingMode0(X, file);
case 1
    X = readCombinedPackingMode1(X, file);
case 2
    X = readCombinedPackingMode2(X, file);
otherwise
...
function X = readCombinedPackingMode0(X, file)
...
function X = readCombinedPackingMode1(X, file)
...
function X = readCombinedPackingMode2(X, file)
...
isCombined = isempty(outputChannel);
...
isCombined = isempty(elementNumber);
